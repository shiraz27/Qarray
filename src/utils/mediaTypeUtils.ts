...
/**
 * True if the URL looks like a split-PDF manifest, i.e. the JSON index
 * generated by the per-page upload pipeline. Matches both the original
 * filename (`/pages/manifest.json`) and the Archive.org dashified variant
 * (`/pages/manifest-json`).
 */
